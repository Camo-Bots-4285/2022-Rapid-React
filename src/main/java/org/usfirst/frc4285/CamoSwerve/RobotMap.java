...
public class RobotMap {
    ...
    public static final int STEER_LEFT_FRONT_ID = 5; // 7
    public static final int STEER_LEFT_REAR_ID = 6;  // 8  
    public static final int STEER_RIGHT_FRONT_ID = 8; // 6
    public static final int STEER_RIGHT_REAR_ID = 7; // 5
